...
static struct FScriptStruct_Wallpaper_StaticRegisterNativesFGraphPanelStyle
{
	...
	{
		UScriptStruct::DeferCppStructOps<FGraphPanelStyle>(FName(TEXT("GraphPanelStyle")));
	}
...
static struct FScriptStruct_Wallpaper_StaticRegisterNativesFUMGEditorPalette
{
	...
	{
		UScriptStruct::DeferCppStructOps<FUMGEditorPalette>(FName(TEXT("UMGEditorPalette")));
	}
...
static struct FScriptStruct_Wallpaper_StaticRegisterNativesFEditorCustomizeDetailsView
{
	...
	{
		UScriptStruct::DeferCppStructOps<FEditorCustomizeDetailsView>(FName(TEXT("EditorCustomizeDetailsView")));
	}
